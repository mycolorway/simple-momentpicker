(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.simple['momentpicker'] = factory(root["jQuery"],root["SimpleModule"]);
  }
...
View = (function(superClass) {
  ...
  View.prototype._renderPanel = function() {
    ...
    if (this.opts.inline) {
      return this.panel.insertAfter(this.parent.el);
    } else {
  ...
  View.prototype._clearElValue = function() {
    this.el.val('');
    return this.parent.trigger('datechange', {
      type: this.name,
      moment: null
...
MomentPicker = (function(superClass) {
  ...
  MomentPicker.prototype._creaetView = function(name) {
    ...
    if (this.opts.displayFormat != null) {
      ...
      if (name === 'time') {
        format = format.split(this.opts.formatSplit).pop();
      }
      if (name === 'date') {
...
Timeview = (function(superClass) {
  ...
  Timeview.prototype._getPanelTpl = function() {
    var hour, i, items, j, len, m, minute, ref, ref1;
    items = '';
    m = moment();
    for (hour = i = ref = this.opts.startingHour; ref <= 23 ? i <= 23 : i >= 23; hour = ref <= 23 ? ++i : --i) {
      ref1 = [0, 30];
      for (j = 0, len = ref1.length; j < len; j++) {
        minute = ref1[j];
        m.hour(hour);
        m.minute(minute);
        items += "<a class='panel-item' data-value='" + (m.format('HH:mm')) + "'>\n  " + (m.format(this.opts.format)) + "\n</a>";
      }
    }
    return "<div class='hour-panel'>" + items + "</div>";
  };
  ...
  Timeview.prototype._panelItemHandler = function(e) {
    ...
    this.moment.hour(m.hour());
    this.moment.minute(m.minute());
