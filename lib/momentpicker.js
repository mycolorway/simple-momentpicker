...
View = (function(superClass) {
  ...
  View.prototype._onDateChangeHandler = function(e) {
  ...
  View.prototype.select = function(value, refreshInput, finished) {
    ...
    return this.triggerHandler('datechange', {
      moment: this.moment
    });
  };
...
MomentPicker = (function(superClass) {
  ...
  MomentPicker.prototype._bind = function() {
    ...
    this.input.on("focus.momentpicker-" + this.id, (function(_this) {
      return function() {
        return _this.show();
      };
    })(this));
    return $(document).on("click.momentpicker-" + this.id, (function(_this) {
      return function(e) {
  ...
  MomentPicker.prototype.getDate = function() {
    if (this.el.val()) {
      this.date || (this.date = moment(this.el.val(), this.opts.valueFormat));
    }
    if (this.date) {
  ...
  MomentPicker.prototype.destroy = function() {
    ...
    if (!this.opts.inline) {
      this.input.remove();
      this.el.show();
      return $(document).off(".momentpicker-" + this.id);
    }
  };
...
DateView = (function(superClass) {
  ...
  DateView.prototype.currentMonth = null;
  ...
  DateView.prototype.dateReg = /\d{4}-\d{1,2}-\d{1,2}/;

  DateView.prototype._render = function() {
    this.currentMonth = this.moment.format('YYYY-MM');
    return DateView.__super__._render.call(this);
  };
  ...
  DateView.prototype._onClickHandler = function(e) {
    ...
    this.moment.set('month', tmpMoment.format('M') - 1);
    this.moment.set('year', tmpMoment.format('YYYY'));
  ...
  DateView.prototype._onDateChangeHandler = function(e) {
    var newMonth;
    DateView.__super__._onDateChangeHandler.call(this, e);
