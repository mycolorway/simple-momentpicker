(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define('simple-datetimepicker', ["jquery","simple-module"], function (a0,b1) {
      return (root['datetimepicker'] = factory(a0,b1));
    });
    ...
    root.simple['datetimepicker'] = factory(jQuery,SimpleModule);
  }
...
Datetimepicker = (function(superClass) {
  ...
  Datetimepicker.prototype._render = function() {
    ...
    this.picker = $(tpl);
    if (this.opts.cls) {
      this.picker.addClass(this.opts.cls);
    }
...
datetimepicker.date = function(opts) {
  $.extend(opts, {
...
datetimepicker.month = function(opts) {
  $.extend(opts, {
    list: ['year', '%-', 'month'],
...
datetimepicker.time = function(opts) {
  $.extend(opts, {
    list: ['hour', '%-', 'minute'],
